...
public class AkvamarineCornflowerBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:akvamarine_cornflower")
	public static final Block block = null;
	public AkvamarineCornflowerBlock(PerodiumcraftModElements instance) {
		super(instance, 122);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("akvamarine_cornflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:akvamarine_cornflower"), configuredFeature);
		}
	}
	@SubscribeEvent
