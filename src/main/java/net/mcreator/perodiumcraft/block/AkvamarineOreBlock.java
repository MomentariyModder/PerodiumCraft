...
public class AkvamarineOreBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:akvamarine_ore")
	public static final Block block = null;
	public AkvamarineOreBlock(PerodiumcraftModElements instance) {
		super(instance, 35);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:akvamarine_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:akvamarine_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
