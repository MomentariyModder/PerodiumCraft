...
public class EndHochiymOreBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:end_hochiym_ore")
	public static final Block block = null;
	public EndHochiymOreBlock(PerodiumcraftModElements instance) {
		super(instance, 40);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:end_hochiym_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:end_hochiym_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
