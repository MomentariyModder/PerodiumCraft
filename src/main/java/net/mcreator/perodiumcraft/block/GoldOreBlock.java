...
public class GoldOreBlock extends PerodiumcraftModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:gold_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 13)).range(32)
					.square().func_242731_b(1);
			event.getRegistry().register(feature.setRegistryName("gold_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:gold_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
