...
public class InfinitiGrassPlantBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:infiniti_grass_plant")
	public static final Block block = null;
	public InfinitiGrassPlantBlock(PerodiumcraftModElements instance) {
		super(instance, 115);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:infiniti_grass_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
