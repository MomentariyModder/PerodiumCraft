...
public class InfinitiOreBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:infiniti_ore")
	public static final Block block = null;
	public InfinitiOreBlock(PerodiumcraftModElements instance) {
		super(instance, 37);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:infiniti_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:infiniti_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
