...
public class PerodiumBush2Block extends FlowerBlock {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		PerodiumBush2PriNazhatiiPravoiKnopkiMyshiNaRastieniiProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
