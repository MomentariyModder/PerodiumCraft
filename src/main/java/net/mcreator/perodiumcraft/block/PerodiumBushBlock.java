...
import net.mcreator.perodiumcraft.procedures.PerodiumBushUpdateProcedure;
...
public class PerodiumBushBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:perodium_bush")
	public static final Block block = null;
	public PerodiumBushBlock(PerodiumcraftModElements instance) {
		super(instance, 402);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("perodium_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:perodium_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PerodiumBushUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
