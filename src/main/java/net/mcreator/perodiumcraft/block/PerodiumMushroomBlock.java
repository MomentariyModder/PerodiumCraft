...
public class PerodiumMushroomBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:perodium_mushroom")
	public static final Block block = null;
	public PerodiumMushroomBlock(PerodiumcraftModElements instance) {
		super(instance, 407);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("perodium_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:perodium_mushroom"), configuredFeature);
		}
	}
	@SubscribeEvent
