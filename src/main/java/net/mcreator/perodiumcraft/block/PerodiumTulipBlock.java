...
public class PerodiumTulipBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:perodium_tulip")
	public static final Block block = null;
	public PerodiumTulipBlock(PerodiumcraftModElements instance) {
		super(instance, 121);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("perodium_tulip"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:perodium_tulip"), configuredFeature);
		}
	}
	@SubscribeEvent
