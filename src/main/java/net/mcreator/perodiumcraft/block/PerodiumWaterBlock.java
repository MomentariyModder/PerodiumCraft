...
public class PerodiumWaterBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:perodium_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("perodiumcraft:perodium_water_bucket")
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("perodiumcraft:blocks/perodiumwaterstill"),
						new ResourceLocation("perodiumcraft:blocks/perodiumwaterflow")).luminosity(0).density(1000).viscosity(1000))
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:perodium_water_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
