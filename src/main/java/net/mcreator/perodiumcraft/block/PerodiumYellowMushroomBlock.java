...
public class PerodiumYellowMushroomBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:perodium_yellow_mushroom")
	public static final Block block = null;
	public PerodiumYellowMushroomBlock(PerodiumcraftModElements instance) {
		super(instance, 406);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("perodium_yellow_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:perodium_yellow_mushroom"),
					configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("perodiumcraft:perodium_zombie_plains").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("perodiumcraft:perodium_oak_forest").equals(event.getName()))
			biomeCriteria = true;
		...
		if (new ResourceLocation("perodiumcraft:perodium_oak_forest").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("perodiumcraft:akvamarine_birch_forest").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("perodiumcraft:ruby_jungle_forest").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("perodium_yellow_mushroom");
		}
