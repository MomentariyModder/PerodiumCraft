...
public class RubyDandeleonBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:ruby_dandeleon")
	public static final Block block = null;
	public RubyDandeleonBlock(PerodiumcraftModElements instance) {
		super(instance, 123);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ruby_dandeleon"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:ruby_dandeleon"), configuredFeature);
		}
	}
	@SubscribeEvent
