...
public class RubyGrassPlantBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:ruby_grass_plant")
	public static final Block block = null;
	public RubyGrassPlantBlock(PerodiumcraftModElements instance) {
		super(instance, 113);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:ruby_grass_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
