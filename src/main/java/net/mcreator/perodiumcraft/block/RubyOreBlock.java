...
public class RubyOreBlock extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(PerodiumcraftModElements instance) {
		super(instance, 33);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft:ruby_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
