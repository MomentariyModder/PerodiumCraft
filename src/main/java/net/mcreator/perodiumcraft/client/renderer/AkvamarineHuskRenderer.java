...
public class AkvamarineHuskRenderer extends HumanoidMobRenderer<AkvamarineHuskEntity, HumanoidModel<AkvamarineHuskEntity>> {
	public AkvamarineHuskRenderer(EntityRendererProvider.Context context) {
