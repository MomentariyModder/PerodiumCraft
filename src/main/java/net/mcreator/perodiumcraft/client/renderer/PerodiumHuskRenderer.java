...
public class PerodiumHuskRenderer extends HumanoidMobRenderer<PerodiumHuskEntity, HumanoidModel<PerodiumHuskEntity>> {
	public PerodiumHuskRenderer(EntityRendererProvider.Context context) {
