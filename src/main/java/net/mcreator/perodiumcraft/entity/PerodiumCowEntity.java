...
public class PerodiumCowEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(PerodiumcraftModEntities.PERODIUM_COW, 20, 4, 4));
	}

	public PerodiumCowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(PerodiumcraftModEntities.PERODIUM_COW, world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PerodiumcraftModItems.PERODIUM_MEAT));
	}
	...
	public static void init() {
		SpawnPlacements.register(PerodiumcraftModEntities.PERODIUM_COW, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
