...
import net.mcreator.perodiumcraft.client.particle.PortalParticle;
...
public class PerodiumcraftModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType PORTAL = register(new SimpleParticleType(false).setRegistryName("portal"), PortalParticle::provider);
