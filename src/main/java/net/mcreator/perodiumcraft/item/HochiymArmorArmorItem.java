...
public class HochiymArmorArmorItem extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:hochiym_armor_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("perodiumcraft:hochiym_armor_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("perodiumcraft:hochiym_armor_armor_leggings")
		...
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(PerodiumCraftToolsandArmorsItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "perodiumcraft:textures/models/armor/hochiymarmor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
