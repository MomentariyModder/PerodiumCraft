...
public class InfinitiItem extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:infiniti")
	public static final Item block = null;
	public InfinitiItem(PerodiumcraftModElements instance) {
		super(instance, 6);
	}
