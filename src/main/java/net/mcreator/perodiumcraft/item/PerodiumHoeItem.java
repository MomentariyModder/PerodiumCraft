...
public class PerodiumHoeItem extends HoeItem {
	public PerodiumHoeItem() {
		super(new Tier() {
			public int getUses() {
				return 4062;
			}
		...
		}, 0, -3f, new Item.Properties().tab(PerodiumcraftModTabs.TAB_PERODIUM_CRAFT_TOOLSAND_ARMORS).fireResistant());
