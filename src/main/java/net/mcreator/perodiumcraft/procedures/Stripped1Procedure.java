...
public class Stripped1Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == PerodiumcraftModBlocks.AKVAMARINE_OAK.get()
			...
			}
			{
				...
				BlockState _bs = PerodiumcraftModBlocks.STRIPPED_AKVAMARINE_BIRCH.get().defaultBlockState();
