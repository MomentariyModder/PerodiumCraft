...
public class AkvamarineBirchForestBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"perodiumcraft:tree_akvamarine_birch_forest",
				FeatureUtils.register("perodiumcraft:tree_akvamarine_birch_forest", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						BlockStateProvider.simple(PerodiumcraftModBlocks.AKVAMARINE_OAK.get().defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
