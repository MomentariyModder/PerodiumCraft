...
public class AkvamarineZombiePlainsBiome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.configured(new SurfaceBuilderBaseConfiguration(PerodiumcraftModBlocks.AKVAMARINE_DIRT.defaultBlockState(),
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(PerodiumcraftMod.MODID, "akvamarine_zombie_plains"),
				SURFACE_BUILDER);
	}
}
