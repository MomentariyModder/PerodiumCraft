		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.TREE
								.withConfiguration(
										(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(PerodiumCactusBlock.block.getDefaultState()),
												new SimpleBlockStateProvider(Blocks.AIR.getDefaultState()),
												new JungleFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 2),
												new MegaJungleTrunkPlacer(3, 2, 19), new TwoLayerFeature(1, 1, 2)))
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft:perodium_desert"));
			}
		}
	}
	@Override
