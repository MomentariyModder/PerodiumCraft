...
import net.mcreator.perodiumcraft.world.features.treedecorators.PerodiumMountainFruitDecorator;
...
public class PerodiumMountainBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("perodiumcraft:tree_perodium_mountain",
						FeatureUtils.register("perodiumcraft:tree_perodium_mountain", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										...
										new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
												.decorators(ImmutableList.of(
														...
														PerodiumMountainFruitDecorator.INSTANCE))
												.build()),
