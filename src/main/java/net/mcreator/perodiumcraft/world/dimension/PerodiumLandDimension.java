...
public class PerodiumLandDimension extends PerodiumcraftModElements.ModElement {
	@ObjectHolder("perodiumcraft:perodium_land_portal")
	public static final CustomPortalBlock portal = null;
	public PerodiumLandDimension(PerodiumcraftModElements instance) {
		super(instance, 1);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("perodiumcraft:perodium_land"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("perodiumcraft:perodium_land"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("perodiumcraft:perodium_land")));
				} else {
					entity.func_242279_ag();
