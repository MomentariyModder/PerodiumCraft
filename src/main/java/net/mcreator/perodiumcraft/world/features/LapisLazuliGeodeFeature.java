...
public class LapisLazuliGeodeFeature extends Feature<NoneFeatureConfiguration> {
	public static final LapisLazuliGeodeFeature FEATURE = (LapisLazuliGeodeFeature) new LapisLazuliGeodeFeature()
			.setRegistryName("perodiumcraft:lapis_lazuli_geode");
