...
public class PerodiumQuartzGeodeFeature extends Feature<NoneFeatureConfiguration> {
	public static final PerodiumQuartzGeodeFeature FEATURE = (PerodiumQuartzGeodeFeature) new PerodiumQuartzGeodeFeature()
			.setRegistryName("perodiumcraft:perodium_quartz_geode");
