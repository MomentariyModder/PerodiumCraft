...
public class PerodiumWaterFeature extends LakeFeature {
	public static PerodiumWaterFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PerodiumWaterFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("perodiumcraft:perodium_water", FEATURE, new LakeFeature.Configuration(
				BlockStateProvider.simple(PerodiumcraftModBlocks.PERODIUM_WATER.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("perodiumcraft:perodium_water", CONFIGURED_FEATURE,
