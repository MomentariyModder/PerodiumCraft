...
public class DeepslateRubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("perodiumcraft:deepslate_ruby_ore", FEATURE, new OreConfiguration(
				DeepslateRubyOreFeatureRuleTest.INSTANCE, PerodiumcraftModBlocks.DEEPSLATE_RUBY_ORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("perodiumcraft:deepslate_ruby_ore", CONFIGURED_FEATURE,
	...
	private static class DeepslateRubyOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<DeepslateRubyOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec
				.unit(() -> INSTANCE);
		private static final RuleTestType<DeepslateRubyOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:deepslate_ruby_ore_match"), CUSTOM_MATCH);
		}
