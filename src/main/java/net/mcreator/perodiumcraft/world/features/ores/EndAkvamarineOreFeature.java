...
public class EndAkvamarineOreFeature extends OreFeature {
	public static final EndAkvamarineOreFeature FEATURE = (EndAkvamarineOreFeature) new EndAkvamarineOreFeature()
			.setRegistryName("perodiumcraft:end_akvamarine_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(
					new OreConfiguration(EndAkvamarineOreFeatureRuleTest.INSTANCE, PerodiumcraftModBlocks.END_AKVAMARINE_ORE.defaultBlockState(), 8))
	...
	private static class EndAkvamarineOreFeatureRuleTest extends RuleTest {
		...
		static final com.mojang.serialization.Codec<EndAkvamarineOreFeatureRuleTest> codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		static final RuleTestType<EndAkvamarineOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("perodiumcraft:end_akvamarine_ore_match"), () -> codec);
