...
public class PerodiumRubyOreFeature extends OreFeature {
	public static final PerodiumRubyOreFeature FEATURE = (PerodiumRubyOreFeature) new PerodiumRubyOreFeature()
			.setRegistryName("perodiumcraft:perodium_ruby_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(
					new OreConfiguration(PerodiumRubyOreFeatureRuleTest.INSTANCE, PerodiumcraftModBlocks.PERODIUM_RUBY_ORE.defaultBlockState(), 12))
	...
	private static class PerodiumRubyOreFeatureRuleTest extends RuleTest {
		...
		static final com.mojang.serialization.Codec<PerodiumRubyOreFeatureRuleTest> codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		static final RuleTestType<PerodiumRubyOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("perodiumcraft:perodium_ruby_ore_match"), () -> codec);
