...
public class RubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("perodiumcraft:ruby_ore", FEATURE,
				new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, PerodiumcraftModBlocks.RUBY_ORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("perodiumcraft:ruby_ore", CONFIGURED_FEATURE,
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft:ruby_ore_match"), CUSTOM_MATCH);
		}
