...
public class RubyOreFeature extends OreFeature {
	public static final RubyOreFeature FEATURE = (RubyOreFeature) new RubyOreFeature().setRegistryName("perodiumcraft:ruby_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, PerodiumcraftModBlocks.RUBY_ORE.defaultBlockState(), 8))
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<RubyOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("perodiumcraft:ruby_ore_match"), () -> codec);
