...
public class PerodiumYellowMushroomFeature extends DefaultFlowerFeature {
	public static final PerodiumYellowMushroomFeature FEATURE = (PerodiumYellowMushroomFeature) new PerodiumYellowMushroomFeature()
			.setRegistryName("perodiumcraft:perodium_yellow_mushroom");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new RandomPatchConfiguration.GrassConfigurationBuilder(
					new SimpleStateProvider(PerodiumcraftModBlocks.PERODIUM_YELLOW_MUSHROOM.defaultBlockState()), SimpleBlockPlacer.INSTANCE)
							.tries(64)
