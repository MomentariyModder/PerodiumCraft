...
public class PerodiumDesertLeaveDecorator extends LeaveVineDecorator {
	public static final PerodiumDesertLeaveDecorator INSTANCE = new PerodiumDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("perodium_desert_tree_leave_decorator");
