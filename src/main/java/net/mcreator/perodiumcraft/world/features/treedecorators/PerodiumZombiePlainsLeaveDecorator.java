...
public class PerodiumZombiePlainsLeaveDecorator extends LeaveVineDecorator {
	public static final PerodiumZombiePlainsLeaveDecorator INSTANCE = new PerodiumZombiePlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("perodium_zombie_plains_tree_leave_decorator");
