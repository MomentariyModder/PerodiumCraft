...
public class RubyPlainsFruitDecorator extends CocoaDecorator {
	public static final RubyPlainsFruitDecorator INSTANCE = new RubyPlainsFruitDecorator();
	public static com.mojang.serialization.Codec<RubyPlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ruby_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public RubyPlainsFruitDecorator() {
		super(0.2f);
	}
