...
public class RubyPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final RubyPlainsLeaveDecorator INSTANCE = new RubyPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ruby_plains_tree_leave_decorator");
