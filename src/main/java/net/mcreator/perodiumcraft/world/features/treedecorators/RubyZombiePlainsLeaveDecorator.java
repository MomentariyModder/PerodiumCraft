...
public class RubyZombiePlainsLeaveDecorator extends LeaveVineDecorator {
	public static final RubyZombiePlainsLeaveDecorator INSTANCE = new RubyZombiePlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ruby_zombie_plains_tree_leave_decorator");
