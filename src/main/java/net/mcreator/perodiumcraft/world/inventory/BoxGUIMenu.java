...
package net.mcreator.perodiumcraft.world.inventory;
...
import net.mcreator.perodiumcraft.procedures.BoxGUIPriZakrytiiGUIProcedure;
import net.mcreator.perodiumcraft.procedures.BoxGUIPriOtkrytiiGUIProcedure;
import net.mcreator.perodiumcraft.init.PerodiumcraftModMenus;
...
public class BoxGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BoxGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PerodiumcraftModMenus.BOX_GUI, id);
		...
		BoxGUIPriOtkrytiiGUIProcedure.execute(world, x, y, z);
	}
	...
	public void removed(Player playerIn) {
		...
		BoxGUIPriZakrytiiGUIProcedure.execute(world, x, y, z);
