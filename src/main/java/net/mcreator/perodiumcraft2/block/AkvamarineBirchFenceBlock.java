...
public class AkvamarineBirchFenceBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_birch_fence")
	public static final Block block = null;
	public AkvamarineBirchFenceBlock(Perodiumcraft2ModElements instance) {
		super(instance, 92);
	}
