...
public class AkvamarineBirchFenceGateBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_birch_fence_gate")
	public static final Block block = null;
	public AkvamarineBirchFenceGateBlock(Perodiumcraft2ModElements instance) {
		super(instance, 95);
	}
