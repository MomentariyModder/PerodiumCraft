...
public class AkvamarineBirchSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_birch_slab")
	public static final Block block = null;
	public AkvamarineBirchSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 89);
	}
