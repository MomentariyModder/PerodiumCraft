...
public class AkvamarineBirchStairsBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_birch_stairs")
	public static final Block block = null;
	public AkvamarineBirchStairsBlock(Perodiumcraft2ModElements instance) {
		super(instance, 86);
	}
