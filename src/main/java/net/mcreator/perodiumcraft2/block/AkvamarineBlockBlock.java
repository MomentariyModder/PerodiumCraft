...
public class AkvamarineBlockBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_block")
	public static final Block block = null;
	public AkvamarineBlockBlock(Perodiumcraft2ModElements instance) {
		super(instance, 50);
	}
