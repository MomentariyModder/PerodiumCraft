...
public class AkvamarineDirtBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_dirt")
	public static final Block block = null;
	public AkvamarineDirtBlock(Perodiumcraft2ModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(3f, 3f).setLightLevel(s -> 0).harvestLevel(4)
