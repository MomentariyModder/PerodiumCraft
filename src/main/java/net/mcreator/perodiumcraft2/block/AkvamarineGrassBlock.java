...
public class AkvamarineGrassBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_grass")
	public static final Block block = null;
	public AkvamarineGrassBlock(Perodiumcraft2ModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("akvamarine_grass");
		}
