...
public class AkvamarineLeavesBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_leaves")
	public static final Block block = null;
	public AkvamarineLeavesBlock(Perodiumcraft2ModElements instance) {
		super(instance, 77);
	}
