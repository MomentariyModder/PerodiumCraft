...
public class AkvamarineOakBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_oak")
	public static final Block block = null;
	public AkvamarineOakBlock(Perodiumcraft2ModElements instance) {
		super(instance, 80);
	}
