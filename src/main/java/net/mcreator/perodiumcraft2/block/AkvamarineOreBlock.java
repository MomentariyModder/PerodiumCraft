...
public class AkvamarineOreBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_ore")
	public static final Block block = null;
	public AkvamarineOreBlock(Perodiumcraft2ModElements instance) {
		super(instance, 32);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft2:akvamarine_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("akvamarine_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:akvamarine_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
