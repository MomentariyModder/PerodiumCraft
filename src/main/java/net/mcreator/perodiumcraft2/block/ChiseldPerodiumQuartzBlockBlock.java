...
public class ChiseldPerodiumQuartzBlockBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:chiseld_perodium_quartz_block")
	public static final Block block = null;
	public ChiseldPerodiumQuartzBlockBlock(Perodiumcraft2ModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseld_perodium_quartz_block");
		}
