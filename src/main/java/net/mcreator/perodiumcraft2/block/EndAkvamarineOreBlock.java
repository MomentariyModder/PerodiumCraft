...
public class EndAkvamarineOreBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:end_akvamarine_ore")
	public static final Block block = null;
	public EndAkvamarineOreBlock(Perodiumcraft2ModElements instance) {
		super(instance, 41);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("end_akvamarine_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft2:end_akvamarine_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("end_akvamarine_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:end_akvamarine_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
