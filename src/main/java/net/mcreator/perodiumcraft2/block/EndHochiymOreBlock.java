...
public class EndHochiymOreBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:end_hochiym_ore")
	public static final Block block = null;
	public EndHochiymOreBlock(Perodiumcraft2ModElements instance) {
		super(instance, 40);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("end_hochiym_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft2:end_hochiym_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("end_hochiym_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:end_hochiym_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
