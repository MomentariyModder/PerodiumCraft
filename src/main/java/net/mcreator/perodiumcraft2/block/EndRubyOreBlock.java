...
public class EndRubyOreBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:end_ruby_ore")
	public static final Block block = null;
	public EndRubyOreBlock(Perodiumcraft2ModElements instance) {
		super(instance, 42);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft2:end_ruby_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("end_ruby_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:end_ruby_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
