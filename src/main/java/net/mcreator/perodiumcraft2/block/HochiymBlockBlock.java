...
public class HochiymBlockBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:hochiym_block")
	public static final Block block = null;
	public HochiymBlockBlock(Perodiumcraft2ModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(10f, 60f).setLightLevel(s -> 0).harvestLevel(4)
