...
public class HochiymDirtBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:hochiym_dirt")
	public static final Block block = null;
	public HochiymDirtBlock(Perodiumcraft2ModElements instance) {
		super(instance, 72);
	}
