...
public class HochiymOreBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:hochiym_ore")
	public static final Block block = null;
	public HochiymOreBlock(Perodiumcraft2ModElements instance) {
		super(instance, 31);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft2:hochiym_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:hochiym_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
