...
public class InfinitiDirtBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:infiniti_dirt")
	public static final Block block = null;
	public InfinitiDirtBlock(Perodiumcraft2ModElements instance) {
		super(instance, 74);
	}
