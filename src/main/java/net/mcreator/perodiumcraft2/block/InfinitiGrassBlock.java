...
public class InfinitiGrassBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:infiniti_grass")
	public static final Block block = null;
	public InfinitiGrassBlock(Perodiumcraft2ModElements instance) {
		super(instance, 68);
	}
