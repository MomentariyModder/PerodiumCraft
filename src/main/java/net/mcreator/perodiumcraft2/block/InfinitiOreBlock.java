...
public class InfinitiOreBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:infiniti_ore")
	public static final Block block = null;
	public InfinitiOreBlock(Perodiumcraft2ModElements instance) {
		super(instance, 34);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("perodiumcraft2:infiniti_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("infiniti_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:infiniti_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
