...
public class PerodiumBarsBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_bars")
	public static final Block block = null;
	public PerodiumBarsBlock(Perodiumcraft2ModElements instance) {
		super(instance, 16);
	}
