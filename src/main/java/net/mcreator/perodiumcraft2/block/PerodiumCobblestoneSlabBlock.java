...
public class PerodiumCobblestoneSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_cobblestone_slab")
	public static final Block block = null;
	public PerodiumCobblestoneSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("perodium_cobblestone_slab");
		}
