...
public class PerodiumCobblestoneWallBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_cobblestone_wall")
	public static final Block block = null;
	public PerodiumCobblestoneWallBlock(Perodiumcraft2ModElements instance) {
		super(instance, 29);
	}
