...
public class PerodiumDirtBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_dirt")
	public static final Block block = null;
	public PerodiumDirtBlock(Perodiumcraft2ModElements instance) {
		super(instance, 70);
	}
