...
public class PerodiumGlassBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_glass")
	public static final Block block = null;
	public PerodiumGlassBlock(Perodiumcraft2ModElements instance) {
		super(instance, 101);
	}
