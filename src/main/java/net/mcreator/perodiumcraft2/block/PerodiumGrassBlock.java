...
public class PerodiumGrassBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_grass")
	public static final Block block = null;
	public PerodiumGrassBlock(Perodiumcraft2ModElements instance) {
		super(instance, 65);
	}
