...
public class PerodiumOakBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak")
	public static final Block block = null;
	public PerodiumOakBlock(Perodiumcraft2ModElements instance) {
		super(instance, 79);
	}
