...
public class PerodiumOakDoorBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_door")
	public static final Block block = null;
	public PerodiumOakDoorBlock(Perodiumcraft2ModElements instance) {
		super(instance, 97);
	}
