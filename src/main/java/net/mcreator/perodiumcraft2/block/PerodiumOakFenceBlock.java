...
public class PerodiumOakFenceBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_fence")
	public static final Block block = null;
	public PerodiumOakFenceBlock(Perodiumcraft2ModElements instance) {
		super(instance, 91);
	}
