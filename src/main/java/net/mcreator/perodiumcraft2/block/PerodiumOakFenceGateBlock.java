...
public class PerodiumOakFenceGateBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_fence_gate")
	public static final Block block = null;
	public PerodiumOakFenceGateBlock(Perodiumcraft2ModElements instance) {
		super(instance, 94);
	}
