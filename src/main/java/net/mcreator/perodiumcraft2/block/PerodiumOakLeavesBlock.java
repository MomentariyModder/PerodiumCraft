...
public class PerodiumOakLeavesBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_leaves")
	public static final Block block = null;
	public PerodiumOakLeavesBlock(Perodiumcraft2ModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, -1.6, 16, 16, 16)).withOffset(offset.x, offset.y, offset.z);
		}
