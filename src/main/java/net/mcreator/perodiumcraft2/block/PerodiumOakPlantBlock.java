...
public class PerodiumOakPlantBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_plant")
	public static final Block block = null;
	public PerodiumOakPlantBlock(Perodiumcraft2ModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("perodium_oak_plant");
		}
