...
public class PerodiumOakSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_slab")
	public static final Block block = null;
	public PerodiumOakSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 88);
	}
