...
public class PerodiumOakStairsBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_oak_stairs")
	public static final Block block = null;
	public PerodiumOakStairsBlock(Perodiumcraft2ModElements instance) {
		super(instance, 85);
	}
