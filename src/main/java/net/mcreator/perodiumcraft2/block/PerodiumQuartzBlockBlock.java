...
public class PerodiumQuartzBlockBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_quartz_block")
	public static final Block block = null;
	public PerodiumQuartzBlockBlock(Perodiumcraft2ModElements instance) {
		super(instance, 56);
	}
