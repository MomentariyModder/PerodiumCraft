...
public class PerodiumQuartzBrickBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_quartz_brick")
	public static final Block block = null;
	public PerodiumQuartzBrickBlock(Perodiumcraft2ModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("perodium_quartz_brick");
		}
