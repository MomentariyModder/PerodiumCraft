...
public class PerodiumQuartzPillarBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_quartz_pillar")
	public static final Block block = null;
	public PerodiumQuartzPillarBlock(Perodiumcraft2ModElements instance) {
		super(instance, 64);
	}
