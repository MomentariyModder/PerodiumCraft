...
public class PerodiumQuartzSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_quartz_slab")
	public static final Block block = null;
	public PerodiumQuartzSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 58);
	}
