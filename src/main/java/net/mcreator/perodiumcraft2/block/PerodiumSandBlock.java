...
public class PerodiumSandBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_sand")
	public static final Block block = null;
	public PerodiumSandBlock(Perodiumcraft2ModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(3f, 7.5f).setLightLevel(s -> 0).harvestLevel(4)
