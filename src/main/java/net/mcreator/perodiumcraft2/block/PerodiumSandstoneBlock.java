...
public class PerodiumSandstoneBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_sandstone")
	public static final Block block = null;
	public PerodiumSandstoneBlock(Perodiumcraft2ModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.4f, 12f).setLightLevel(s -> 0).harvestLevel(4)
