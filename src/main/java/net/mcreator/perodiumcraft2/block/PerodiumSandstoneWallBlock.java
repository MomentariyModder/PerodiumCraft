...
public class PerodiumSandstoneWallBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_sandstone_wall")
	public static final Block block = null;
	public PerodiumSandstoneWallBlock(Perodiumcraft2ModElements instance) {
		super(instance, 30);
	}
