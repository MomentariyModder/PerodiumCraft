...
public class PerodiumSmoothStoneBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_smooth_stone")
	public static final Block block = null;
	public PerodiumSmoothStoneBlock(Perodiumcraft2ModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("perodium_smooth_stone");
		}
