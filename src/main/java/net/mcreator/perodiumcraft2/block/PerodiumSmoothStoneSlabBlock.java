...
public class PerodiumSmoothStoneSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_smooth_stone_slab")
	public static final Block block = null;
	public PerodiumSmoothStoneSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("perodium_smooth_stone_slab");
		}
