...
public class PerodiumStoneBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_stone")
	public static final Block block = null;
	public PerodiumStoneBlock(Perodiumcraft2ModElements instance) {
		super(instance, 18);
	}
