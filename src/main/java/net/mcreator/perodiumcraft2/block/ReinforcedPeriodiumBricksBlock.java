...
public class ReinforcedPeriodiumBricksBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:reinforced_periodium_bricks")
	public static final Block block = null;
	public ReinforcedPeriodiumBricksBlock(Perodiumcraft2ModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(9f, 45f).setLightLevel(s -> 0).harvestLevel(4)
