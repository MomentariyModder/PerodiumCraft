...
public class RubyBlockBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(Perodiumcraft2ModElements instance) {
		super(instance, 52);
	}
