...
public class RubyDirtBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_dirt")
	public static final Block block = null;
	public RubyDirtBlock(Perodiumcraft2ModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(3f, 3f).setLightLevel(s -> 0).harvestLevel(3)
