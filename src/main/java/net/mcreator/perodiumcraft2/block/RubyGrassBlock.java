...
public class RubyGrassBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_grass")
	public static final Block block = null;
	public RubyGrassBlock(Perodiumcraft2ModElements instance) {
		super(instance, 69);
	}
