...
public class RubyGrassPlantBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_grass_plant")
	public static final Block block = null;
	public RubyGrassPlantBlock(Perodiumcraft2ModElements instance) {
		super(instance, 106);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ruby_grass_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("perodiumcraft2:ruby_grass_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("perodiumcraft2:ruby_jungle_biome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
