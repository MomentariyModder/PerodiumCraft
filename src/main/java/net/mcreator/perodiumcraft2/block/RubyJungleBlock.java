...
public class RubyJungleBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_jungle")
	public static final Block block = null;
	public RubyJungleBlock(Perodiumcraft2ModElements instance) {
		super(instance, 81);
	}
