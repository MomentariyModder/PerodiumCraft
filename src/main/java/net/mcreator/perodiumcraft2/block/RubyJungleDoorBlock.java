...
public class RubyJungleDoorBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_jungle_door")
	public static final Block block = null;
	public RubyJungleDoorBlock(Perodiumcraft2ModElements instance) {
		super(instance, 99);
	}
