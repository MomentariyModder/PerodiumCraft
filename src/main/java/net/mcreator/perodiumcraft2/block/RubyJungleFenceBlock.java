...
public class RubyJungleFenceBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_jungle_fence")
	public static final Block block = null;
	public RubyJungleFenceBlock(Perodiumcraft2ModElements instance) {
		super(instance, 93);
	}
