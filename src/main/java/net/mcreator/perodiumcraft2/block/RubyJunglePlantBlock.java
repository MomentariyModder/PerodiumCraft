...
public class RubyJunglePlantBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_jungle_plant")
	public static final Block block = null;
	public RubyJunglePlantBlock(Perodiumcraft2ModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(6f, 6f).setLightLevel(s -> 0).harvestLevel(3)
