...
public class RubyJungleSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_jungle_slab")
	public static final Block block = null;
	public RubyJungleSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 90);
	}
