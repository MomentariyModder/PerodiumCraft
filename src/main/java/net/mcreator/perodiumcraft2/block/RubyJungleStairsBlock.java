...
public class RubyJungleStairsBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_jungle_stairs")
	public static final Block block = null;
	public RubyJungleStairsBlock(Perodiumcraft2ModElements instance) {
		super(instance, 87);
	}
