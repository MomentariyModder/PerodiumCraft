...
public class SmoothPerodiumQuartzBlockBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:smooth_perodium_quartz_block")
	public static final Block block = null;
	public SmoothPerodiumQuartzBlockBlock(Perodiumcraft2ModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_perodium_quartz_block");
		}
