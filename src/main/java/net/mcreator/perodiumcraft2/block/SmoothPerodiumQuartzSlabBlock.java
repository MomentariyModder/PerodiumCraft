...
public class SmoothPerodiumQuartzSlabBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:smooth_perodium_quartz_slab")
	public static final Block block = null;
	public SmoothPerodiumQuartzSlabBlock(Perodiumcraft2ModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_perodium_quartz_slab");
		}
