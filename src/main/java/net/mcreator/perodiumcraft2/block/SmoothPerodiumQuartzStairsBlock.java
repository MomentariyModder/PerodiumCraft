...
public class SmoothPerodiumQuartzStairsBlock extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:smooth_perodium_quartz_stairs")
	public static final Block block = null;
	public SmoothPerodiumQuartzStairsBlock(Perodiumcraft2ModElements instance) {
		super(instance, 60);
	}
