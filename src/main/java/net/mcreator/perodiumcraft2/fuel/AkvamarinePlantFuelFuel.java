...
import net.mcreator.perodiumcraft2.block.AkvamarineBirchPlanksBlock;
import net.mcreator.perodiumcraft2.Perodiumcraft2ModElements;

@Perodiumcraft2ModElements.ModElement.Tag
public class AkvamarinePlantFuelFuel extends Perodiumcraft2ModElements.ModElement {
	public AkvamarinePlantFuelFuel(Perodiumcraft2ModElements instance) {
		super(instance, 239);
