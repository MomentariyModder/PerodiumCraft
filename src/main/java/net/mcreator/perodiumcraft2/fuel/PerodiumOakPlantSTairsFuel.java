...
import net.mcreator.perodiumcraft2.block.PerodiumOakStairsBlock;
import net.mcreator.perodiumcraft2.Perodiumcraft2ModElements;

@Perodiumcraft2ModElements.ModElement.Tag
public class PerodiumOakPlantSTairsFuel extends Perodiumcraft2ModElements.ModElement {
	public PerodiumOakPlantSTairsFuel(Perodiumcraft2ModElements instance) {
		super(instance, 251);
