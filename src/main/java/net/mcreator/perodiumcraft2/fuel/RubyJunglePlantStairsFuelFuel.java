...
import net.mcreator.perodiumcraft2.block.RubyJungleStairsBlock;
import net.mcreator.perodiumcraft2.Perodiumcraft2ModElements;

@Perodiumcraft2ModElements.ModElement.Tag
public class RubyJunglePlantStairsFuelFuel extends Perodiumcraft2ModElements.ModElement {
	public RubyJunglePlantStairsFuelFuel(Perodiumcraft2ModElements instance) {
		super(instance, 247);
