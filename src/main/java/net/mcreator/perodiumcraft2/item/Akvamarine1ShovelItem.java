...
public class Akvamarine1ShovelItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_1_shovel")
	public static final Item block = null;
	public Akvamarine1ShovelItem(Perodiumcraft2ModElements instance) {
		super(instance, 120);
	}
