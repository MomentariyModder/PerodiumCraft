...
public class AkvamarineDustItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine_dust")
	public static final Item block = null;
	public AkvamarineDustItem(Perodiumcraft2ModElements instance) {
		super(instance, 11);
	}
