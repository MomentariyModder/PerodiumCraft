...
public class AkvamarineItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:akvamarine")
	public static final Item block = null;
	public AkvamarineItem(Perodiumcraft2ModElements instance) {
		super(instance, 3);
	}
