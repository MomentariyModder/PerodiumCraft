...
public class HochiymDustItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:hochiym_dust")
	public static final Item block = null;
	public HochiymDustItem(Perodiumcraft2ModElements instance) {
		super(instance, 10);
	}
