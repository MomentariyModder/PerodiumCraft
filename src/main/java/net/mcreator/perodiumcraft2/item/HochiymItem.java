...
public class HochiymItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:hochiym")
	public static final Item block = null;
	public HochiymItem(Perodiumcraft2ModElements instance) {
		super(instance, 2);
	}
