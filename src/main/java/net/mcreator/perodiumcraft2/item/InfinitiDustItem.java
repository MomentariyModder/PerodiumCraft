...
public class InfinitiDustItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:infiniti_dust")
	public static final Item block = null;
	public InfinitiDustItem(Perodiumcraft2ModElements instance) {
		super(instance, 12);
	}
