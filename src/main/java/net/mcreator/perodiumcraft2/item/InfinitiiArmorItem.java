...
public class InfinitiiArmorItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:infinitii_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("perodiumcraft2:infinitii_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("perodiumcraft2:infinitii_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("perodiumcraft2:infinitii_armor_boots")
	public static final Item boots = null;
	public InfinitiiArmorItem(Perodiumcraft2ModElements instance) {
		super(instance, 122);
	}
		...
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(PerodiumCraftToolsandArmorsItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "perodiumcraft2:textures/models/armor/infinitii_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
