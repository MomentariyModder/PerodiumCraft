...
public class InfinitiiAxeItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:infinitii_axe")
	public static final Item block = null;
	public InfinitiiAxeItem(Perodiumcraft2ModElements instance) {
		super(instance, 125);
	}
