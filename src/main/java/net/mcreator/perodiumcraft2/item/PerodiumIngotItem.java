...
public class PerodiumIngotItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_ingot")
	public static final Item block = null;
	public PerodiumIngotItem(Perodiumcraft2ModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("perodium_ingot");
		}
