...
public class PerodiumNuggetsItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_nuggets")
	public static final Item block = null;
	public PerodiumNuggetsItem(Perodiumcraft2ModElements instance) {
		super(instance, 8);
	}
