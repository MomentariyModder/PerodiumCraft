...
public class PerodiumPlateItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_plate")
	public static final Item block = null;
	public PerodiumPlateItem(Perodiumcraft2ModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("perodium_plate");
		}
