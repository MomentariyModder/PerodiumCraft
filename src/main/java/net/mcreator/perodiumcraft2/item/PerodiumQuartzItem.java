...
public class PerodiumQuartzItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:perodium_quartz")
	public static final Item block = null;
	public PerodiumQuartzItem(Perodiumcraft2ModElements instance) {
		super(instance, 6);
	}
