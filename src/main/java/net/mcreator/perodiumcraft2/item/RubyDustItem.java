...
public class RubyDustItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:ruby_dust")
	public static final Item block = null;
	public RubyDustItem(Perodiumcraft2ModElements instance) {
		super(instance, 13);
	}
