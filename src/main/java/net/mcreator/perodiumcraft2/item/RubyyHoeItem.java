...
public class RubyyHoeItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:rubyy_hoe")
	public static final Item block = null;
	public RubyyHoeItem(Perodiumcraft2ModElements instance) {
		super(instance, 133);
	}
