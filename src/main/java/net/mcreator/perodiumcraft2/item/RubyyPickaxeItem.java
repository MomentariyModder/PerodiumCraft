...
public class RubyyPickaxeItem extends Perodiumcraft2ModElements.ModElement {
	@ObjectHolder("perodiumcraft2:rubyy_pickaxe")
	public static final Item block = null;
	public RubyyPickaxeItem(Perodiumcraft2ModElements instance) {
		super(instance, 130);
	}
