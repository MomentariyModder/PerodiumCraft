...
import net.mcreator.perodiumcraft2.item.PerodiumIngotItem;
import net.mcreator.perodiumcraft2.Perodiumcraft2ModElements;

@Perodiumcraft2ModElements.ModElement.Tag
public class PerodiumCraftItemItemGroup extends Perodiumcraft2ModElements.ModElement {
	public PerodiumCraftItemItemGroup(Perodiumcraft2ModElements instance) {
		super(instance, 202);
	}
