...
public class AkvamarineZombiePlainsBiome extends Perodiumcraft2ModElements.ModElement {
	public static Biome biome;
	public AkvamarineZombiePlainsBiome(Perodiumcraft2ModElements instance) {
		super(instance, 155);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft2:akvamarine_zombie_plains"));
			}
		}
	}
	@Override
