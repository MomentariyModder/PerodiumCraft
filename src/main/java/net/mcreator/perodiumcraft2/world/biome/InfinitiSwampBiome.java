...
import net.mcreator.perodiumcraft2.block.InfinitiGrassBlock;
import net.mcreator.perodiumcraft2.block.InfinitiDirtBlock;
import net.mcreator.perodiumcraft2.Perodiumcraft2ModElements;

@Perodiumcraft2ModElements.ModElement.Tag
public class InfinitiSwampBiome extends Perodiumcraft2ModElements.ModElement {
	public static Biome biome;
	public InfinitiSwampBiome(Perodiumcraft2ModElements instance) {
		super(instance, 162);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft2:infiniti_swamp"));
			}
		}
	}
	@Override
