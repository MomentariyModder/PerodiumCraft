...
import net.mcreator.perodiumcraft2.block.PerodiumSandstoneBlock;
import net.mcreator.perodiumcraft2.block.PerodiumSandBlock;
...
public class PerodiumDesertBiome extends Perodiumcraft2ModElements.ModElement {
	public static Biome biome;
	public PerodiumDesertBiome(Perodiumcraft2ModElements instance) {
		super(instance, 174);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(PerodiumSandBlock.block.getDefaultState(),
								PerodiumSandstoneBlock.block.getDefaultState(), PerodiumSandstoneBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft2:perodium_desert"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("perodium_desert_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("perodium_desert_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("perodium_desert_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
