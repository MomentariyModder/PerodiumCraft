...
import net.mcreator.perodiumcraft2.block.PerodiumOakLeavesBlock;
import net.mcreator.perodiumcraft2.block.PerodiumOakBlock;
import net.mcreator.perodiumcraft2.block.PerodiumGrassBlock;
import net.mcreator.perodiumcraft2.block.PerodiumDirtBlock;
...
public class PerodiumOakForestBiome extends Perodiumcraft2ModElements.ModElement {
	public static Biome biome;
	public PerodiumOakForestBiome(Perodiumcraft2ModElements instance) {
		super(instance, 231);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft2:perodium_oak_forest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("perodium_oak_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("perodium_oak_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("perodium_oak_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
