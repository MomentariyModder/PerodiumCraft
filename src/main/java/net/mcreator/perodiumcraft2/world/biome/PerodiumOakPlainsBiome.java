...
public class PerodiumOakPlainsBiome extends Perodiumcraft2ModElements.ModElement {
	public static Biome biome;
	public PerodiumOakPlainsBiome(Perodiumcraft2ModElements instance) {
		super(instance, 232);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft2:perodium_oak_plains"));
			}
		}
	}
	@Override
