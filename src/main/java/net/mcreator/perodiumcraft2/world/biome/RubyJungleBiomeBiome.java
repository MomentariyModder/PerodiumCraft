...
import net.mcreator.perodiumcraft2.block.RubyJungleLeavesBlock;
import net.mcreator.perodiumcraft2.block.RubyJungleBlock;
import net.mcreator.perodiumcraft2.block.RubyGrassBlock;
import net.mcreator.perodiumcraft2.block.RubyDirtBlock;
...
public class RubyJungleBiomeBiome extends Perodiumcraft2ModElements.ModElement {
	public static Biome biome;
	public RubyJungleBiomeBiome(Perodiumcraft2ModElements instance) {
		super(instance, 172);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("perodiumcraft2:ruby_jungle_biome"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("ruby_jungle_biome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("ruby_jungle_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("ruby_jungle_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
